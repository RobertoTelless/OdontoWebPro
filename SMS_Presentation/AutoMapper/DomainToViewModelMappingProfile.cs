...
namespace MvcMapping.Mappers
{
    public class DomainToViewModelMappingProfiles : Profile
    {
        public DomainToViewModelMappingProfiles()
        {
            ...
            CreateMap<REGIAO_DENTE, DenteRegiaoViewModel>();
            CreateMap<TIPO_PROCEDIMENTO_ANEXO, TipoProcedimentoAnexoViewModel>();
            CreateMap<TIPO_PROCEDIMENTO, TipoProcedimentoViewModel>();
            CreateMap<PACIENTE, PacienteViewModel>();
            CreateMap<PACIENTE_ACOMPANHAMENTO, PacienteAcompanhamentoViewModel>();
            CreateMap<PACIENTE_PRESCRICAO, PacientePrescricaoViewModel>();
            CreateMap<PACIENTE_RECOMENDACAO, PacienteRecomendacaoViewModel>();
            ...
            CreateMap<PACIENTE_ANAMNESE_PERGUNTA, PacientePerguntaViewModel>();
            CreateMap<SUB_PROCEDIMENTO, SubProcedimentoViewModel>();
            CreateMap<ORCAMENTO, OrcamentoViewModel>();
            CreateMap<ORCAMENTO_ACOMPANHAMENTO, OrcamentoAcompanhamentoViewModel>();
            CreateMap<ORCAMENTO_ITEM, OrcamentoItemViewModel>();
